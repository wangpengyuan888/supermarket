# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-02-09 00:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_name', models.CharField(max_length=20, validators=['收', '货', '人'])),
                ('phone', models.CharField(max_length=11, validators=[django.core.validators.RegexValidator('^1[3-9]\\d{9}$', '手机格式错误')], verbose_name='手机号码')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.UserTable', verbose_name='创建人')),
            ],
            options={
                'verbose_name': '收获地址管理',
